...
while i > 0:
    ...
    state = (platform * 4) + (direction % 4) # Nova variável STATE como inteiro para ser usada nos acessos à q_table # Nova variável STATE como inteiro para ser usada nos acessos à q_table
